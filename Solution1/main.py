...
def main():
    ...
    cache_handler = CacheHandler(REDIS_HOST, REDIS_PORT)
    ...
    files_to_process = s3_handler.get_files()

    # Process files in parallel using ThreadPoolExecutor
    with ThreadPoolExecutor(max_workers=5) as executor:
        futures = [executor.submit(job_processor.process_file, file_key) for file_key in files_to_process]
